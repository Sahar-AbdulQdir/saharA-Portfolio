...
@media(max-width:900px){
  ...
  /* Show the laptop on mobile, but smaller */
  .lm-hero-visual{display:flex; margin-top: 32px;}
  
  .lm-laptop { max-width: 320px; }
        ...
        <section className="project-gallery">
          ...
          <div className="gallery-block">
            <div className="gallery-text">
              ...
              <p>
                The MongoDB database uses two collections — User and SavedItem — keeping account data separate from content. Each saved item (book or podcast) is linked to a user by ID, enabling personalised bookmarking without data duplication. The backend is built with Node.js and Express, using bcrypt for password security and CORS middleware for frontend–backend communication.
              </p>
            </div>
            <div className="gallery-image">
