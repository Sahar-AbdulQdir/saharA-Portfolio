...
const apps = [
  {
    id: 1, type: "app", name: "Orbit", subtitle: "Task Management App", date: "Aug 2025",
  ...
  {
    id: 2, type: "app", name: "Echo", subtitle: "Voice Platform App", date: "Nov 2025",
...
const websites = [
  {
    id: 3, type: "web", name: "Horizon", subtitle: "Analytics Dashboard", date: "Jan 2025",
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
  ...
  {
    id: 4, type: "web", name: "Pulse", subtitle: "E-Commerce Platform", date: "Mar 2025",
    video: "https://www.w3schools.com/html/movie.mp4",
  ...
  {
    id: 5, type: "web", name: "Flux", subtitle: "Design System Site", date: "Jun 2025",
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontFamily: "'Fraunces',serif", fontWeight: "700", fontSize: isMobile ? "18px" : "22px", color: "#111827", lineHeight: 1.05, letterSpacing: "-0.02em", marginBottom: "3px" }}>{project.name}</div>
        <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "10px", color: "#9ca3af", marginBottom: "6px" }}>{project.subtitle}</div>
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ position: "relative", cursor: "pointer" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: "13px", paddingLeft: "2px", paddingRight: "2px" }}>
        <div>
          <div style={{ fontFamily: "'Fraunces',serif", fontWeight: "700", fontSize: "21px", color: "#111827", letterSpacing: "-0.02em", lineHeight: 1.05 }}>{project.name}</div>
  ...
  return (
    <div onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{ position: "relative", cursor: "pointer" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: "11px", paddingLeft: "2px", paddingRight: "2px" }}>
        <div>
          <div style={{ fontFamily: "'Fraunces',serif", fontWeight: "700", fontSize: "16px", color: "#111827", letterSpacing: "-0.02em", lineHeight: 1.1 }}>{project.name}</div>
